...
SPRING_BOOT_PAYMENT_WITH_SAVED_CARD_URL = env('SPRING_BOOT_PAYMENT_WITH_SAVED_CARD_URL', default='http://localhost:8084/api/payment/create-payment')
...
SPRING_BOOT_BANK_ACCOUNT_URL = env('SPRING_BOOT_BANK_ACCOUNT_URL', default='http://localhost:8084/api/payment/bank-account')
SPRING_BOOT_WITHDRAW_URL = env('SPRING_BOOT_WITHDRAW_URL', default='http://localhost:8084/api/payment/create-payout')
